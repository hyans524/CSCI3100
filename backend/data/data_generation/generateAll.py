...
from generateExpense import generate_expense
...
groups = generate_group(100, user_oid)
...
expenses = generate_expense(groups)

with open('./backend/data/initial_data/expense.json', 'w') as f:
    json.dump(expenses, f, default=json_serializer, indent=4)