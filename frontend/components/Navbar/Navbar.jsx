            ...
            <div className="flex items-center">
                ...
                <div className="flex items-center justify-center space-x-4 mr-3">
                    ...
                    <NavLink
                        to="/profile"
                        className={({ isActive }) =>
                            `flex items-center justify-center h-10 w-10 rounded-full overflow-hidden hover:shadow-lg transform hover:scale-105 transition-all duration-300 ${isActive ? "ring-2 ring-blue-500 ring-offset-1" : "hover:ring-1 hover:ring-blue-300 hover:ring-offset-1"
                            }`
                        }
                        onClick={() => window.scrollTo(0, 0)}
                        title="Your profile"
